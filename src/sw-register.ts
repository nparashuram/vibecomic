/**
 * Registers the service worker in production builds only (the dev server has no
 * sw.js, and one would cache stale modules), and shows a "new version
 * available" banner when the worker reports UPDATE_READY.
 */
